...
var coreBusinessSchema = mongoose.Schema({
  name: {
    en: {
      type: String,
      required: true
...
coreBusinessSchema.pre("save", /*#__PURE__*/function () {
...
coreBusinessSchema.pre("findOneAndUpdate", /*#__PURE__*/function () {
...
var CoreBusiness = mongoose.model("CoreBusiness", coreBusinessSchema);
