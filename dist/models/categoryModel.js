...
categorySchema.pre("save", /*#__PURE__*/function () {
      ...
      while (1) switch (_context.n) {
        case 0:
          ...
          if (this.subcategories && this.subcategories.length > 0) {
            this.subcategories = this.subcategories.map(function (subcategory) {
...
categorySchema.pre("findOneAndUpdate", /*#__PURE__*/function () {
      ...
      while (1) switch (_context2.n) {
        case 0:
          ...
          if (update.subcategories && update.subcategories.length > 0) {
            update.subcategories = update.subcategories.map(function (subcategory) {
              if (!subcategory.href && subcategory.name && subcategory.name.en) {
                subcategory.href = slugify(subcategory.name.en);
              }
              return subcategory;
